...
/// OOK decoder for receive sensitivity tests based on FS20 protocol with different checksum.
class PowerTestDecoder : public DecodeOOK {
  public:
    PowerTestDecoder () {}
    PowerTestDecoder (uint8_t id, const char* tag, decoded_cb cb) : DecodeOOK (id, tag, cb) {}
